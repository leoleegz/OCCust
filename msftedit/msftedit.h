...
// MSFTEDIT_API functions as being imported from a DLL, wheras this DLL sees symbols
// defined with this macro as being exported.
#ifdef MSFTEDIT_EXPORTS
#define MSFTEDIT_API __declspec(dllexport)
#else
#define MSFTEDIT_API __declspec(dllimport)
#endif
...
extern "C" VOID	   WINAPI  SetCustomTextOutHandlerEx();
extern "C" HRESULT WINAPI  DllGetVersion(DLLVERSIONINFO *pdvi);
extern "C" LRESULT WINAPI  RichEditWndProc(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam);
extern "C" LRESULT WINAPI  RichListBoxWndProc(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam);
extern "C" LRESULT WINAPI  RichComboBoxWndProc(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam);
